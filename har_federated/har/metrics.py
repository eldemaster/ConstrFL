"""
Advanced Metrics for Federated Learning - HAR Version
Metriche utili per analizzare qualità e fairness del FL con UCI HAR (6 classi)
"""
...
def evaluate_model_detailed(model, x_test, y_test, num_classes=6):
    ...
    Args:
        ...
        num_classes: numero di classi (6 per UCI HAR)
...
class MetricsLogger:
    ...
    def save_final_summary(self, additional_info=None):
        ...
        with open(summary_path, 'w') as f:
            f.write("=" * 70 + "\n")
            f.write(f"FEDERATED LEARNING EXPERIMENT SUMMARY - UCI HAR\n")
            f.write("=" * 70 + "\n\n")
...
def print_metrics_summary(round_num, centralized_metrics, distributed_metrics, 
    ...
    """
    Stampa un summary leggibile delle metriche per UCI HAR
    """
    print(f"\n{'='*70}")
    ...
    # Centralized
    print(f"\n📊 Centralized Evaluation (Validation Set):")
