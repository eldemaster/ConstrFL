"""
WISDM: Flower ServerApp with Advanced Metrics + Gradient Compression
"""
...
from wisdm.task import load_model, load_global_validation_data, load_global_test_data
from wisdm.compressed_strategy import CompressedFedAvg  # 🆕 Compression support
...
from wisdm.client_metrics import client_tracker, enhanced_fit_metrics_aggregation
...
def server_fn(context: fl.common.Context):
    ...
    early_stopping_min_epochs = run_config.get("early-stopping-min-epochs", 0)
    ...
    def fit_config(server_round: int):
        ...
        # 🆕 PHASE 4: Early Stopping parameters
    ...
    # Define the strategy with Compression Support
    ...
    print(f"\n{'='*70}")
    print(f"🚀 Starting Federated Learning - WISDM")
    print(f"{'='*70}")
